...
sb.add_filter_wheel_step(filter_number=1)
...
sb.add_filter_wheel_step(filter_number=2)
...
sb.add_filter_wheel_step(filter_number=3)
sb.add_sequence('Green', exposure=5, count=2)
sb.add_filter_wheel_step(filter_number=4)
