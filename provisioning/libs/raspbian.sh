...
install_prerequisites() {
    apt-get update && apt-get install -y cdbs libcfitsio-dev libnova-dev libusb-1.0-0-dev libjpeg-dev \
        ...
        ${python_pkgname}-pip i${python_pkgname} ${python_pkgname}-dev git hostapd tmux dnsmasq swig shellinabox \
	libftdi1-2 libgsl2 libogg0 libtheora0 libfreetype6-dev fonts-dejavu-core 
}
